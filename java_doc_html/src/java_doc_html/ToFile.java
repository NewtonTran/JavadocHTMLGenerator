 ...
 * When using this class, put the name of the desired text file in the INPUT_NAME, put the same name in the OUTPUT_NAME 
 * but with .html instead of .txt. make sure the inputed text file is in the same project folder as this package before 
 * running this method.
 *
 */
public class ToFile {
